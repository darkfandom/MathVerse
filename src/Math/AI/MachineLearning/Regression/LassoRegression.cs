...
/// </summary>
public sealed class LassoRegression
{
    ...
    public LassoRegression(double alpha = 1.0, int maxIterations = 1000, double tolerance = 1e-6)
    {
        if (alpha < 0)
    ...
    /// <summary>
    /// Trains the Lasso regression model using coordinate descent with soft thresholding.
    /// </summary>
    ...
    public void Train(double[][] X, double[] y)
    {
        ...
        for (int iteration = 0; iteration < _maxIterations; iteration++)
        {
            ...
            for (int j = 0; j < p; j++)
            {
                ...
                _coefficients[j] = SoftThreshold(rho, _alpha) / colNorms[j];
